...
@Component({
  selector: 'app-boda-client-info',
  templateUrl: './boda-client-info.component.html',
  styleUrls: ['./boda-client-info.component.scss']
})
export class BodaClientInfoComponent implements OnInit {
  registered = false;
  submitted = false;
  errored = false;
  posted = false;
