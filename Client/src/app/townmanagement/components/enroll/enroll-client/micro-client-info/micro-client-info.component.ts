...
@Component({
  selector: 'app-micro-client-info',
  templateUrl: './micro-client-info.component.html',
  styleUrls: ['./micro-client-info.component.scss']
})
export class MicroClientInfoComponent implements OnInit {
  registered = false;
  submitted = false;
  errored = false;
  posted = false;
