...
@Component({
  selector: 'app-taxi-client-info',
  templateUrl: './taxi-client-info.component.html',
  styleUrls: ['./taxi-client-info.component.scss']
})
export class TaxiClientInfoComponent implements OnInit {
  registered = false;
  submitted = false;
  errored = false;
  posted = false;
