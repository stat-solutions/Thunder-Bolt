...
@Component({
  selector: 'app-edit-taxi-client-info',
  templateUrl: './edit-taxi-client-info.component.html',
  styleUrls: ['./edit-taxi-client-info.component.scss']
})
export class EditTaxiClientInfoComponent implements OnInit {
  registered = false;
  submitted = false;
  errored = false;
  posted = false;
