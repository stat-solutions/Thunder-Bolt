...
@Component({
  selector: 'app-edit-boda-client-info',
  templateUrl: './edit-boda-client-info.component.html',
  styleUrls: ['./edit-boda-client-info.component.scss']
})
export class EditBodaClientInfoComponent implements OnInit {
  registered = false;
  submitted = false;
  errored = false;
  posted = false;
