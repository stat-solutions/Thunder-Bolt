...
@Component({
  selector: 'app-approve-town-users',
  templateUrl: './approve-town-users.component.html',
  styleUrls: ['./approve-town-users.component.scss'],
})
export class ApproveTownUsersComponent implements OnInit {
  userForm: FormGroup;
  ...
  rejectItems() {
    ...
    if (itemsRejected.length > 0) {
      setTimeout(() => {
        this.router.navigate(['townmanagement/dashboard']);
      }, 3000);
    } else {
      // alert("Please select something")
      return;
