...
var WaiveInterestComponent = /** @class */ (function () {
    function WaiveInterestComponent(authService, others, router, spinner, alertService, modalService) {
    ...
    WaiveInterestComponent.prototype.checkLoanType = function (value) {
        var _this = this;
        switch (value) {
            case 'Boda Loan':
    ...
    WaiveInterestComponent.prototype.choosingPdts = function () {
        this.loanType = '';
        this.numberPlates = [];
        this.phoneNumbers = [];
    };
    WaiveInterestComponent.prototype.checkLoanbility = function (value, template) {
        var _this = this;
        if (value !== '') {
    ...
    WaiveInterestComponent.prototype.openModal = function (template) {
        this.modalRef = this.modalService.show(template, Object.assign({}, { "class": 'modal-lg modal-dialog-centered' }));
    };
    // toggle visibility of password field
    WaiveInterestComponent.prototype.toggleFieldType = function () {
        this.fieldType = !this.fieldType;
    };
    WaiveInterestComponent.prototype.waiveInterest = function () {
        var _this = this;
            ...
            this.others.verifyUserWithPin({ userPhone1: this.User.userPhone, userPassword: Number(this.fval.pin.value) }).subscribe(function (res) {
                if (res) {
                    var data = {
                        ...
                        theInterestToBeWiaved: amount,
                        userId: _this.User.userId,
                        comment: "Please waive interest of " + amount + " on this customer"
                    };
                    _this.others.waiveInterest(data).subscribe(function (response) {
                        if (response === true) {
                            _this.posted = true;
                            _this.alertService.success({
                                html: '<b> Waiving of Interest was Initiated Successfully, wait for approval</b>'
                            });
