...
var WriteOffComponent = /** @class */ (function () {
    function WriteOffComponent(authService, others, router, spinner, alertService, modalService) {
    ...
    WriteOffComponent.prototype.checkLoanType = function (value) {
        var _this = this;
        switch (value) {
            case 'Boda Loan':
    ...
    WriteOffComponent.prototype.choosingPdts = function () {
        this.loanType = '';
        this.numberPlates = [];
        this.phoneNumbers = [];
    };
    ...
    WriteOffComponent.prototype.toggleFieldType = function () {
        this.fieldType = !this.fieldType;
    };
    WriteOffComponent.prototype.writeOff = function () {
        var _this = this;
            ...
            this.others.verifyUserWithPin({ userPhone1: this.User.userPhone, userPassword: Number(this.fval.pin.value) }).subscribe(function (res) {
                if (res) {
                    var data = {
                        ...
                        thePrincipalToBeWiaved: amount,
                        userId: _this.User.userId,
                        comment: "Please waive interest of " + amount + " on this customer"
                    };
                    _this.others.waivePrincimpal(data).subscribe(function (response) {
                        if (response === true) {
                            _this.posted = true;
                            _this.alertService.success({
                                html: '<b> Waiving of Principal was Initiated Successfully, wait for approval</b>'
                            });
