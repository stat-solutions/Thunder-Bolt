...
exports.SetInterestRateComponent = void 0;
var core_1 = require("@angular/core");
var forms_1 = require("@angular/forms");
var custom_validator_1 = require("src/app/validators/custom-validator");
var SetInterestRateComponent = /** @class */ (function () {
    function SetInterestRateComponent(authService, others, router, spinner, alertService, modalService) {
    ...
    SetInterestRateComponent.prototype.ngOnInit = function () {
        this.userForm = this.createFormGroup();
        this.checkedOk = false;
    };
    SetInterestRateComponent.prototype.createFormGroup = function () {
        return new forms_1.FormGroup({
            ...
            itemRate: new forms_1.FormControl({ value: '', disabled: false }, forms_1.Validators.compose([forms_1.Validators.required, custom_validator_1.CustomValidator.maxValue(100)])),
    ...
    SetInterestRateComponent.prototype.checkLoanType = function (value) {
        var _this = this;
        switch (value) {
            case 'Boda Loan':
    ...
    SetInterestRateComponent.prototype.choosingPdts = function () {
        this.loanType = '';
        this.numberPlates = [];
        this.phoneNumbers = [];
    };
    ...
    SetInterestRateComponent.prototype.revert = function () {
        this.userForm.reset();
    };
    SetInterestRateComponent.prototype.refresh = function () {
        location.reload();
    };
    Object.defineProperty(SetInterestRateComponent.prototype, "fval", {
        get: function () {
    ...
    SetInterestRateComponent.prototype.toggleFieldType = function () {
        this.fieldType = !this.fieldType;
    };
    SetInterestRateComponent.prototype.setInterestRate = function () {
        var _this = this;
        var itemRate = this.fval.itemRate.value;
    ...
    SetInterestRateComponent = __decorate([
        core_1.Component({
    ...
    return SetInterestRateComponent;
}());
exports.SetInterestRateComponent = SetInterestRateComponent;
