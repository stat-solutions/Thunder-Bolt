...
exports.AccrualDaysComponent = void 0;
var core_1 = require("@angular/core");
var forms_1 = require("@angular/forms");
var custom_validator_1 = require("src/app/validators/custom-validator");
var AccrualDaysComponent = /** @class */ (function () {
    function AccrualDaysComponent(authService, others, router, spinner, alertService, modalService) {
    ...
    AccrualDaysComponent.prototype.ngOnInit = function () {
        this.userForm = this.createFormGroup();
        this.checkedOk = false;
    };
    AccrualDaysComponent.prototype.createFormGroup = function () {
        return new forms_1.FormGroup({
            ...
            days: new forms_1.FormControl({ value: '', disabled: false }, forms_1.Validators.compose([forms_1.Validators.required, custom_validator_1.CustomValidator.maxValue(100)])),
    ...
    AccrualDaysComponent.prototype.checkLoanType = function (value) {
        var _this = this;
        switch (value) {
            case 'Boda Loan':
    ...
    AccrualDaysComponent.prototype.choosingPdts = function () {
        this.loanType = '';
        this.numberPlates = [];
        this.phoneNumbers = [];
    };
    ...
    AccrualDaysComponent.prototype.revert = function () {
        this.userForm.reset();
    };
    AccrualDaysComponent.prototype.refresh = function () {
        location.reload();
    };
    Object.defineProperty(AccrualDaysComponent.prototype, "fval", {
        get: function () {
    ...
    AccrualDaysComponent.prototype.openModal = function (template) {
        this.modalRef = this.modalService.show(template, Object.assign({}, { "class": 'modal-lg modal-dialog-centered' }));
    };
    // toggle visibility of password field
    AccrualDaysComponent.prototype.toggleFieldType = function () {
        this.fieldType = !this.fieldType;
    };
    AccrualDaysComponent.prototype.setAccrualDyas = function () {
        var _this = this;
    ...
    AccrualDaysComponent = __decorate([
        core_1.Component({
    ...
    return AccrualDaysComponent;
}());
exports.AccrualDaysComponent = AccrualDaysComponent;
