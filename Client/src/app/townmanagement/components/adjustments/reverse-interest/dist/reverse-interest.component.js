...
var ReverseInterestComponent = /** @class */ (function () {
    function ReverseInterestComponent(authService, others, router, spinner, alertService, modalService) {
    ...
    ReverseInterestComponent.prototype.checkLoanType = function (value) {
        var _this = this;
        switch (value) {
            case 'Boda Loan':
    ...
    ReverseInterestComponent.prototype.choosingPdts = function () {
        this.loanType = '';
        this.numberPlates = [];
        this.phoneNumbers = [];
    };
    ReverseInterestComponent.prototype.checkLoanbility = function (value, template) {
        var _this = this;
        if (value !== '') {
    ...
    ReverseInterestComponent.prototype.openModal = function (template) {
        this.modalRef = this.modalService.show(template, Object.assign({}, { "class": 'modal-lg modal-dialog-centered' }));
    };
    // toggle visibility of password field
    ReverseInterestComponent.prototype.toggleFieldType = function () {
        this.fieldType = !this.fieldType;
    };
    ReverseInterestComponent.prototype.reversePrinciple = function () {
        var _this = this;
        ...
        if (this.userForm.valid) {
            this.others.verifyUserWithPin({ userPhone1: this.User.userPhone, userPassword: Number(this.fval.pin.value) }).subscribe(function (res) {
                if (res) {
                    ...
                    _this.others.reverseInterest(data).subscribe(function (response) {
                        if (response === true) {
                            _this.posted = true;
                            _this.alertService.success({
