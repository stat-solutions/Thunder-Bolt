...
var GetLoanComponent = /** @class */ (function () {
        ...
        if (this.showUserForm) {
            ...
            setTimeout(function () {
                var security = {
                    ...
                    // microLoanPurpose: "Adding stock in the business",
                    microLoanSecurityName: _this.securityFval.type.value.toUpperCase(),
                    microLoanSecurityLocation: _this.securityFval.type.value.toUpperCase(),
                    microLoanSecurityPhotoUrl: _this.securityPhotoUrl
                };
                if (security.securityTypeCode) {
                    _this.securities.push(security);
                    console.log(_this.securities);
                    _this.posted = true;
                    _this.alertService.success({
                        html: '<b> saved successfully</b>'
                    });
    ...
    GetLoanComponent.prototype.postLoan = function () {
        ...
        if (this.userForm.valid) {
            if (Number(this.fval.pin.value) === this.checkedClient.customerSecretPin) {
                this.others.putTxnCustomerApproval(this.data).subscribe(function (res) {
                    if (res) {
                        _this.posted = true;
                        _this.alertService.success({
