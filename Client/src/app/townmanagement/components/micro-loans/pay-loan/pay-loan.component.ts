...
checkLoanbility(value: any): any {
    if (value !== ''){
      ...
      if (microCustomers.length === 1){
        this.others.getLoadDetails({customerId: microCustomers[0].customerId, productCode: 400}).subscribe(
          res => {
            this.checkedClient = {
              Id: microCustomers[0].customerId,
              name: microCustomers[0].customerName,
              // tslint:disable-next-line: max-line-length
              photoUrl: microCustomers[0].customerPhotoUrl === 'customerPhotoUrl.com' ? this.user : microCustomers[0].customerPhotoUrl,
              ...
              theStationLocationId: microCustomers[0].fktheStationLocationIdCustomer
            };
