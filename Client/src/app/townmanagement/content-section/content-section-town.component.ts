...
@Component({
  ...
  templateUrl: './content-section-town.component.html',
  styleUrls: ['./content-section-town.component.scss']
})
export class ContentSectionTownComponent implements OnInit {
