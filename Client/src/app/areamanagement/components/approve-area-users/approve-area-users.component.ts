...
@Component({
  selector: 'app-approve-area-users',
  templateUrl: './approve-area-users.component.html',
  styleUrls: ['./approve-area-users.component.scss'],
})
export class ApproveAreaUsersComponent implements OnInit {
  userForm: FormGroup;
