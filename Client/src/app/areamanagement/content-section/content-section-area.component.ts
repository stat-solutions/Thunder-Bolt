...
@Component({
  ...
  templateUrl: './content-section-area.component.html',
  styleUrls: ['./content-section-area.component.scss']
})
export class ContentSectionAreaComponent implements OnInit {
