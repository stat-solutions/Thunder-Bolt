...
@Component({
  selector: 'app-approve-admin-users',
  templateUrl: './approve-admin-users.component.html',
  styleUrls: ['./approve-admin-users.component.scss'],
})
export class ApproveAdminUsersComponent implements OnInit {
  userForm: FormGroup;
