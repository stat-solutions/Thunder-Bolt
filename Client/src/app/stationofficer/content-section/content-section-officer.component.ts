...
@Component({
  ...
  templateUrl: './content-section-officer.component.html',
  styleUrls: ['./content-section-officer.component.scss']
})
export class ContentSectionOfficerComponent implements OnInit {
