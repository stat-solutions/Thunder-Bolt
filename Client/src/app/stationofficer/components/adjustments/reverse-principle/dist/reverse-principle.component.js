...
var ReversePrincipleComponent = /** @class */ (function () {
    function ReversePrincipleComponent(authService, router, spinner, alertService, modalService) {
    ...
    ReversePrincipleComponent.prototype.checkLoanType = function (value) {
        // console.log(value);
        this.loanType = value;
    };
    ...
    ReversePrincipleComponent.prototype.onKey = function (event) {
        // without type info
    ...
    ReversePrincipleComponent.prototype.openModal = function (template) {
        this.modalRef = this.modalService.show(template, Object.assign({}, { "class": 'modal-lg modal-dialog-centered' }));
    };
    ReversePrincipleComponent.prototype.getTheNumberPlates = function () {
    ...
    ReversePrincipleComponent.prototype.checkLoanbility = function () {
        // this.pumpService
    ...
    ReversePrincipleComponent.prototype.reversePrinciple = function () {
