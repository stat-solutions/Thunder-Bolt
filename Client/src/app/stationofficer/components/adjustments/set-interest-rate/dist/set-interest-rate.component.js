...
var SetInterestRateComponent = /** @class */ (function () {
    function SetInterestRateComponent(authService, router, spinner, alertService, modalService) {
    ...
    SetInterestRateComponent.prototype.onKey = function (event) {
        // without type info
    ...
    SetInterestRateComponent.prototype.getTheNumberPlates = function () {
