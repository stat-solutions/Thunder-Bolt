...
var SetLoanLimitComponent = /** @class */ (function () {
    function SetLoanLimitComponent(authService, router, spinner, alertService, modalService) {
    ...
    SetLoanLimitComponent.prototype.createFormGroup = function () {
        return new forms_1.FormGroup({
            ...
            itemLimit: new forms_1.FormControl({ value: '', disabled: true }, forms_1.Validators.compose([forms_1.Validators.required,
    ...
    SetLoanLimitComponent.prototype.onKey = function (event) {
        // without type info
    ...
    SetLoanLimitComponent.prototype.getTheNumberPlates = function () {
