...
var WriteOffComponent = /** @class */ (function () {
    function WriteOffComponent(authService, router, spinner, alertService, modalService) {
    ...
    WriteOffComponent.prototype.onKey = function (event) {
        // without type info
    ...
    WriteOffComponent.prototype.getTheNumberPlates = function () {
