...
var WaiveInterestComponent = /** @class */ (function () {
    function WaiveInterestComponent(authService, router, spinner, alertService, modalService) {
    ...
    WaiveInterestComponent.prototype.onKey = function (event) {
        // without type info
    ...
    WaiveInterestComponent.prototype.getTheNumberPlates = function () {
    ...
    WaiveInterestComponent.prototype.checkLoanbility = function () {
        // this.pumpService
