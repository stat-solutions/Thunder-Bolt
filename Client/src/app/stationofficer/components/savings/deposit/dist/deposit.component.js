...
var DepositComponent = /** @class */ (function () {
    function DepositComponent(authService, router, spinner, alertService, modalService) {
    ...
    DepositComponent.prototype.onKey = function (event) {
        // without type info
    ...
    DepositComponent.prototype.getTheNumberPlates = function () {
