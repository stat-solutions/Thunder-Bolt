...
var AreaComponent = /** @class */ (function () {
    function AreaComponent(fb, modalService, authService, others, router, spinner, alertService) {
        this.fb = fb;
    ...
    AreaComponent.prototype.fetchReport = function (val) {
        if (val.length > 1) {
    ...
    AreaComponent.prototype.fetchReports = function (dates, typeOfReport) {
        var _this = this;
        switch (typeOfReport) {
            case 'Cash Ledger':
                ...
                break;
            case 'All Loans':
                this.others.getAllLoansByStation(this.User.userLocationId).subscribe(function (res) {
                    _this.singleReport = res;
                }, function (err) {
                    console.log(err);
                });
    ...
    AreaComponent.prototype.openModal = function (template, photoUrl) {
