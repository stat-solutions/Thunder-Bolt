...
@Component({
  ...
  templateUrl: './content-section-station.component.html',
  styleUrls: ['./content-section-station.component.scss']
})
export class ContentSectionStationComponent implements OnInit {
