...
exports.WithdrawFloatComponent = void 0;
var core_1 = require("@angular/core");
var forms_1 = require("@angular/forms");
var WithdrawFloatComponent = /** @class */ (function () {
    function WithdrawFloatComponent(authService, others, spinner, router, alertService) {
    ...
    WithdrawFloatComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    WithdrawFloatComponent.prototype.createFormGroup = function () {
    ...
    WithdrawFloatComponent.prototype.revert = function () {
        this.userForm.reset();
    };
    Object.defineProperty(WithdrawFloatComponent.prototype, "fval", {
        get: function () {
    ...
    WithdrawFloatComponent.prototype.withdraw = function () {
        var _this = this;
        if (this.userForm.valid) {
            ...
            for (var _b = 0, _c = this.txns; _b < _c.length; _b++) {
                var txn = _c[_b];
                if (txn.txnDetailsTypeName.toUpperCase() === 'FLOATWITHDRAWAL') {
            ...
            if (data.theStationLocationId === null) {
                ...
                this.others.putTxnNoneCustomer(data).subscribe(function (res) {
                    ...
                    _this.alertService.success({
                        html: '<b> Withdraw was successfully</b>'
                    });
    ...
    WithdrawFloatComponent = __decorate([
        core_1.Component({
    ...
    return WithdrawFloatComponent;
}());
exports.WithdrawFloatComponent = WithdrawFloatComponent;
