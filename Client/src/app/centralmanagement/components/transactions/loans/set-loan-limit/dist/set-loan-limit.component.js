...
var SetLoanLimitComponent = /** @class */ (function () {
    function SetLoanLimitComponent(authService, others, spinner, router, alertService) {
    ...
    SetLoanLimitComponent.prototype.createFormGroup = function () {
        return new forms_1.FormGroup({
            itemLimit: new forms_1.FormControl('', forms_1.Validators.compose([
    ...
    SetLoanLimitComponent.prototype.setLimit = function () {
        var _this = this;
        // this.spinner.show();
        if (this.userForm.valid) {
            var data_1 = {
                theStationLocationConstantsLoanLimit: this.fval.itemLimit.value,
                productCode: null,
            ...
            if (data_1.theStationLocationId === null) {
                ...
                this.others.postSetStationLoanLimit(data_1).subscribe(function (res) {
                    _this.posted = true;
                    _this.alertService.success({
                        html: '<b> The loan limit was set successfully</b>'
                    });
