...
exports.SetLoanRateComponent = void 0;
var core_1 = require("@angular/core");
var forms_1 = require("@angular/forms");
var custom_validator_1 = require("src/app/validators/custom-validator");
var SetLoanRateComponent = /** @class */ (function () {
    function SetLoanRateComponent(authService, others, spinner, router, alertService) {
    ...
    SetLoanRateComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    SetLoanRateComponent.prototype.createFormGroup = function () {
        return new forms_1.FormGroup({
            itemRate: new forms_1.FormControl('', forms_1.Validators.compose([forms_1.Validators.required, custom_validator_1.CustomValidator.maxValue(100)])),
    ...
    SetLoanRateComponent.prototype.revert = function () {
        this.userForm.reset();
    };
    Object.defineProperty(SetLoanRateComponent.prototype, "fval", {
        get: function () {
    ...
    SetLoanRateComponent.prototype.setRate = function () {
        var _this = this;
        // this.spinner.show();
        if (this.userForm.valid) {
            var data_1 = {
                theStationLocationConstantsInterest: this.fval.itemRate.value,
                productCode: null,
            ...
            if (data_1.theStationLocationId === null) {
                ...
                this.others.postSetStationLoanInterestRate(data_1).subscribe(function (res) {
                    _this.posted = true;
                    _this.alertService.success({
                        html: '<b> The Loan Interest Rate was set successfully</b>'
                    });
    ...
    SetLoanRateComponent = __decorate([
        core_1.Component({
    ...
    return SetLoanRateComponent;
}());
exports.SetLoanRateComponent = SetLoanRateComponent;
