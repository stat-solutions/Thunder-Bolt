...
exports.SetLoanCommissionComponent = void 0;
var core_1 = require("@angular/core");
var forms_1 = require("@angular/forms");
var custom_validator_1 = require("src/app/validators/custom-validator");
var SetLoanCommissionComponent = /** @class */ (function () {
    function SetLoanCommissionComponent(authService, others, spinner, router, alertService) {
    ...
    SetLoanCommissionComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    SetLoanCommissionComponent.prototype.createFormGroup = function () {
        return new forms_1.FormGroup({
            commission: new forms_1.FormControl('', forms_1.Validators.compose([forms_1.Validators.required, custom_validator_1.CustomValidator.maxValue(100)])),
    ...
    SetLoanCommissionComponent.prototype.revert = function () {
        this.userForm.reset();
    };
    Object.defineProperty(SetLoanCommissionComponent.prototype, "fval", {
        get: function () {
    ...
    SetLoanCommissionComponent.prototype.setCommission = function () {
        var _this = this;
        // this.spinner.show();
        if (this.userForm.valid) {
            var data_1 = {
                theStationLocationConstantsCommissionRate: this.fval.commission.value,
                productCode: null,
            ...
            if (data_1.theStationLocationId === null) {
                ...
                this.others.postSetStationCommissionRate(data_1).subscribe(function (res) {
                    _this.posted = true;
                    _this.alertService.success({
                        html: '<b> The commission rate was set successfully</b>'
                    });
    ...
    SetLoanCommissionComponent = __decorate([
        core_1.Component({
            selector: 'app-set-loan-commision',
            templateUrl: './set-loan-commision.component.html',
            styleUrls: ['./set-loan-commision.component.scss']
        })
    ], SetLoanCommissionComponent);
    return SetLoanCommissionComponent;
}());
exports.SetLoanCommissionComponent = SetLoanCommissionComponent;
